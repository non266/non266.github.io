var LANGUAGES = {
    ...
    "cn": {
        texts: {
            "page-title": "小北啊啊啊",
            "doc-title": "啊啊啊~",
            "page-descriptions": "给小北写的小网站，对，就是那个最可爱的《ウマ娘》角色！",
            "counter-descriptions": ["小北已经啊~了", "小北已经啊了"],
            "counter-unit": ["次", "次啊啊啊"],
            "counter-button": ["啊啊啊~", "啊啊啊！"],
...
(() => {
    ...
    cacheStaticObj("img/kitasan1.gif");
    cacheStaticObj("img/kitasan2.gif");
    cacheStaticObj("img/kitasan3.gif");
    cacheStaticObj("img/kitasan4.gif");
    ...
    function animateHerta() {
        ...
        elem.src = cacheStaticObj(`img/kitasan${random}.gif`);
