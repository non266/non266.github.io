var LANGUAGES = {
    ...
    "cn": {
        texts: {
            "page-title": "傻了吧唧曼波~",
            "doc-title": "曼波~",
            "page-descriptions": "给傻了吧唧写的小网站，对，就是那个最可爱的《ウマ娘》角色！",
            "counter-descriptions": ["傻了吧唧已经曼波~了", "傻了吧唧已经曼波了"],
            "counter-unit": ["次", "次曼波"],
            "counter-button": ["曼波~", "曼波！"],
...
(() => {
    ...
    let localCount = localStorage.getItem('tannhauser') || 0;
    ...
    function addBtnEvent() {
        counterButton.addEventListener('click', (e) => {
            localCount++;
            localCounter.textContent = localCount.toLocaleString('en-US');
            localStorage.setItem('tannhauser', localCount);
            triggerRipple(e);
            playKuru();
            animateHerta();
            refreshDynamicTexts();
    ...
    cacheStaticObj("img/tannhauser1.gif");
    cacheStaticObj("img/tannhauser2.gif");
    cacheStaticObj("img/tannhauser3.gif");
    cacheStaticObj("img/tannhauser4.gif");
    ...
    function animateHerta() {
        ...
        elem.src = cacheStaticObj(`img/tannhauser${random}.gif`);
