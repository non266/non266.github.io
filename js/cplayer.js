...
function() {
    return function(e) {
        ...
        var l = function() {
            ...
            return r(e, [{
                key: "next",
                value: function() {
                    return this.point = this.nextPoint(),
                    this.playlist[this.point]
                }
            },
            {
                key: "prev",
                value: function() {
                    return this.point = this.prevPoint(),
                    this.playlist[this.point]
                }
            },
            {
            ...
            },
            {
                ...
                value: function() {
                    var e = this.point + 1;
                    return e >= this.__playlist.length && (e = 0),
                    e
                }
            },
            {
                ...
                value: function() {
                    var e = this.point - 1;
                    return e < 0 && (e = this.__playlist.length - 1),
                    e
                }
            },
            {
                ...
                value: function(e) {
                    var t = this,
                    n = o(e, this.__playlist, this.point,
                    function(e) {
    ...
    function(e, t) {
        ...
        n.prototype.emit = function(e) {
            ...
            default:
                ...
                n.apply(this, l)
            } else if (r(n)) for (l = Array.prototype.slice.call(arguments, 1), s = n.slice(), o = s.length, c = 0; c < o; c++) s[c].apply(this, l);
            return ! 0
        },
        n.prototype.addListener = function(e, t) {
            ...
            r(this._events[e]) && !this._events[e].warned && (o = a(this._maxListeners) ? n.defaultMaxListeners: this._maxListeners) && o > 0 && this._events[e].length > o && (this._events[e].warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", this._events[e].length), "function" == typeof console.trace && console.trace()),
            this
        },
        ...
        n.prototype.removeListener = function(e, t) {
            ...
            if (n = this._events[e], a = n.length, o = -1, n === t || i(n.listener) && n.listener === t) delete this._events[e],
            this._events.removeListener && this.emit("removeListener", e, t);
            else if (r(n)) {
                for (l = a; l-->0;) if (n[l] === t || n[l].listener && n[l].listener === t) {
                    o = l;
                    break
                }
                if (o < 0) return this;
    ...
    function(e, t, n) {
        "use strict"; (function(e) {
            ...
            function a(e) {
                return e.map(function(e, t) {
                    var n = Object.assign({},
                    e);
                    return "string" == typeof e.lyric && e.lyric.replace(/\n+/gi, "\n").trim() && (n.lyric = p.decodeLyricStr(e.lyric)),
                    "string" == typeof e.sublyric && e.sublyric.replace(/\n+/gi, "\n").trim() && (n.sublyric = p.decodeLyricStr(e.sublyric)),
                    n
                })
            }
            var l = function() {
            ...
            v = function(t) {
                function n(t) {
                    ...
                    r.eventHandlers = {
                        ...
                        handlePause: function() {
                            r.__paused || r.audioElement.ended || r.play(!0).
                            catch(function(e) {
                                console.log(e),
                                r.pause()
                            })
                    ...
                    t = Object.assign({},
                    m, t),
                    r.playmode = new f[t.playmode](a(t.playlist), t.point),
                    r.view = new y(r, t),
                    h.cplayerMediaSessionPlugin(r),
                    e(function() {
                        r.openAudio(),
                        r.setVolume(t.volume),
                        t.autoplay && r.playlist.length > 0 && r.play(!0).
                        catch(function(e) {
                            console.log(e),
                            r.pause()
                        })
                ...
                },
                {
                    ...
                    value: function() {
                        ...
                        t = this.isPlaying(),
                        n = void 0;
                        return (!t && this.playlist.length > 0 || e) && (n = this.audioElement.play()),
                        this.__paused && (this.__paused = !1, this.emit("playstatechange", this.__paused), this.emit("play")),
                        n
                    }
                },
                {
                    key: "pause",
                    value: function() {
                        var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0]; (this.isPlaying() && this.playlist.length > 0 || e) && this.audioElement.pause(),
                        this.__paused || (this.__paused = !0, this.emit("playstatechange", this.__paused), this.emit("pause"))
                    }
                },
                {
                    key: "to",
                ...
                },
                {
                    ...
                    value: function(e) {
                        ...
                        this.audioElement && (this.audioElement.volume = Math.max(0, Math.min(1, this._volume))),
                ...
                },
                {
                    ...
                    value: function() {
                        var e = this;
                        this.audioElement && (this.audioElement.src = null, this.audioElement.removeEventListener("timeupdate", this.eventHandlers.handleTimeUpdate), this.removeAllListeners()),
        ...
        default = v;
            var g = function() {
                Array.prototype.forEach.call(document.querySelectorAll("template[cplayer]"),
                function(e) {
    ...
    function(e, t, n) {
        ...
        function o(e, t) {
            ...
            for (var l = 0; l < n.length; l++) if (!a.call(t, n[l]) || !i(e[n[l]], t[n[l]])) return ! 1;
            return ! 0
        }
    ...
    function(e, t, n) {
        ...
        a = function() {
            ...
            },
            {
                ...
                value: function(e) {
                    var t = this,
                    n = r.baseRemoveMusic(e, this.__playlist, this.point,
                    function(e) {
                        return Math.max(0, Math.min(e, t.__playlist.length - 1))
                    }),
                    i = n.playlist,
    ...
    function(e, t, n) {
        ...
        a = function() {
            ...
            return o(e, [{
                key: "next",
                value: function() {
                    return this.point = this.randomPoint(),
    ...
    function(e, t, n) {
        "use strict";
        function i(e) {
            "mediaSession" in navigator && (navigator.mediaSession.metadata = o(e.nowplay), navigator.mediaSession.setActionHandler("play",
            function() {
                return e.play()
    ...
    function(e, t, n) {
        ...
        function a(e) {
            ...
            i = 0; i < e.length; i++) {
                var o = e.charAt(i),
                r = /[ぁ-んァ-ン]/.test(o);
                r && !n && (t += '<span class="cp-lyric-text-zoomout">', n = !0),
                !r && n && (t += "</span>", n = !1),
                t += o
            }
            return n && (t += "</span>"),
        ...
        function u(e, t, n) {
            ...
            document.getElementById("cplayer-style") || document.body.appendChild(s(n)),
            i.firstChild
        }
        function d(e, t, n) {
            var i = document.createElement("div"),
        ...
        x = function(e) {
            function t(e, n) {
                ...
                return r.elementLinks = m.
            default(r.getElementLinks),
                r.dropDownMenuShowInfo = !0,
                r.__OldVolume = 1,
                r.__OldLyric = "",
                r.__OldTotalTime = 0,
                r.handlePlaylistchange = function() {
                    r.updatePlaylist()
                },
                ...
                r.handleOpenAudio = function(e) {
                    "video" !== e.type ? r.setPoster(e.poster || v) : r.setPoster("none"),
                    r.setProgress(0, 0, 0),
                    r.elementLinks.title.innerText = e.name,
                    r.elementLinks.artist.innerText = e.artist || "",
                    r.updateLyric(),
                    r.updatePlaylist()
                },
                ...
                n.deleteElementAfterGenerate && n.element.parentElement.removeChild(n.element),
                r.rootElement.style.width = r.options.width,
                r.rootElement.style.fontSize = r.options.size,
                r.elementLinks = r.getElementLinks(),
                r.injectEventListener(),
                r.setPlayIcon(r.player.paused),
                r.dropDownMenuShowInfo = !r.options.showPlaylist,
                r.dropDownMenuShowInfo ? r.showInfo() : r.showPlaylist(),
                r.options.showPlaylistButton ? r.elementLinks.button.list.style.display = "": r.elementLinks.button.list.style.display = "none",
                r.elementLinks.dropDownMenu.classList.add("cp-drop-down-menu-" + r.options.dropDownMenuMode),
                r.options.dark && r.dark(),
                r.options.big && r.big(),
                r.setPoster(r.player.nowplay.poster || v),
                r.setProgress(r.player.currentTime / r.player.duration, r.player.currentTime, r.player.duration),
                r.elementLinks.title.innerText = r.player.nowplay.name,
                r.elementLinks.artist.innerText = r.player.nowplay.artist || "",
                r.updateLyric(),
                r.updatePlaylist(),
                r
            }
            ...
            },
            {
                ...
                value: function(e, t, n) {
                    this.elementLinks.progressFill.style.width = 100 * e + "%",
                    this.elementLinks.progressButton.style.right = 100 * (1 - e) + "%",
                    this.elementLinks.progressCurrentTime.innerText = c(t),
                    this.elementLinks.progressDuration.innerText = c(n)
                }
            },
            {
                key: "setPoster",
            ...
            },
            {
                ...
                value: function(e) {
                    ...
                    t.value = e,
                    this.elementLinks.button.mode.attributes.setNamedItem(t)
                }
            },
            {
                key: "showInfo",
                value: function() {
                    ...
                    e.style.height = "",
                    e.classList.remove("cp-drop-down-menu-playlist"),
                    e.classList.add("cp-drop-down-menu-info"),
                    this.dropDownMenuShowInfo = !0
                }
            },
            {
                key: "showPlaylist",
                value: function() {
                    var e = this.elementLinks.dropDownMenu;
                    e.style.height = 2.08333 * this.player.playlist.length + "em",
                    e.classList.remove("cp-drop-down-menu-info"),
                    e.classList.add("cp-drop-down-menu-playlist"),
                    this.dropDownMenuShowInfo = !1
                }
            },
            {
                    ...
                    if (this.__OldLyric !== e || this.__OldTotalTime !== n) {
                        if (this.elementLinks.lyric.innerHTML = e, this.elementLinks.lyric.style.transition = "", this.elementLinks.lyric.style.transform = "", 0 !== n) {
                            ...
                            if (i > o) {
                                ...
                                c = Math.min(.6 * l, r),
                                s = r - l;
                                this.elementLinks.lyric.style.transition = "transform " + s + "ms linear " + c + "ms",
                                this.elementLinks.lyric.style.transform = "translateX(-" + a + "px)"
                            }
                        }
                        this.__OldLyric = e,
                        this.__OldTotalTime = n
                    }
                }
            },
            {
                ...
                value: function() {
                    ...
                    this.dropDownMenuShowInfo || (this.elementLinks.dropDownMenu.style.height = 2.08333 * this.player.playlist.length + "em")
                }
            },
            {
                ...
                value: function() {
                    var e = this;
                    Array.prototype.forEach.call(this.elementLinks.playlistItems,
                    function(t, n) {
            ...
            },
            {
                ...
                value: function() {
                    ...
                    this.elementLinks.progress.addEventListener("touchmove", this.handleTouchProgress, {
                        passive: !0
                    }),
