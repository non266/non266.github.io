var LANGUAGES = {
    ...
    "cn": {
        texts: {
            "page-title": "大米叫欧尼sama~",
            "doc-title": "欧尼sama~",
            "page-descriptions": "给大米写的小网站，对，就是那个最可爱的《ウマ娘》角色！",
            "counter-descriptions": ["大米已经叫~了", "大米已经叫欧尼sama了"],
            "counter-unit": ["次", "次叫欧尼sama"],
            "counter-button": ["欧尼sama~", "叫欧尼sama！"],
            //"access-via-pages": "您目前是通过 GitHub Pages 访问。对于中国大陆或其他一些地区的用户，请<a href='https://mirror.non266.top/tannhauser/'>单击此处访问</a>。",
            //"access-via-mirror": "恭喜！你正在使用镜像站，这应当会加速在中国大陆及部分地区境内的访问。点此<a href='https://non266.top/tannhauser/'>访问 GitHub Pages 上的源站</a>。",
...
(() => {
    ...
    let localCount = localStorage.getItem('rice') || 0;
    ...
    function addBtnEvent() {
        counterButton.addEventListener('click', (e) => {
            localCount++;
            localCounter.textContent = localCount.toLocaleString('en-US');
            localStorage.setItem('rice', localCount);
            triggerRipple(e);
            playKuru();
            animateHerta();
            refreshDynamicTexts();
    ...
    cacheStaticObj("img/rice1.gif");
    cacheStaticObj("img/rice2.gif");
    cacheStaticObj("img/rice3.gif");
    cacheStaticObj("img/rice4.gif");
    ...
    function animateHerta() {
        ...
        elem.src = cacheStaticObj(`img/rice${random}.gif`);
